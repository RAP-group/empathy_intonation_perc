...
**Learner response accuracy**. This section contains additional information regarding the response accuracy and response time analyses, as well as tables reported but not included in the main text. 

The response accuracy model was specified in the following manner: 

$$
\begin{aligned}
\text{is_correct}_i & \sim \text{Bernoulli}(\theta_i, \sigma_i = \text{se}_i) \\
