...
Our speaker also tended to use a final rise (L\* HH\%) in wh- questions, which differs from the more common final fall. 
...
For yes-no questions, the boundary tone was typlically HH\%. 
...
For yes/no questions this speaker produced a L\* HH\% nuclear configuration. 
...
With regard to questions, this speaker often used a L+H\* L\% nuclear configuration for wh- questions, and L\* HH\% for yes-no questions. 
...
On occasion this speaker produced final rises for wh- questions (L\* HH\%), but also often used a falling contour. 
For yes/no questions, this speaker produced H+L\* L\% configurations. 
