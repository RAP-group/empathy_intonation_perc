...
That is to say, learners are more sensitive to (and accurate with) statements (declarative broad focus, declarative narrow focus) than questions (interrogative wh-, interrogative yes/no) (left panel of Figure \@ref(fig:plot-learner-dp-utterance-variety). 
...
read_csv(here("tables", "learner_native_accuracy.csv")) %>% 
  mutate(Type = case_when(
    Variety != "Andalusian" & Type == "Declarative broad focus" ~ " ", 
    Variety != "Andalusian" & Type == "Declarative narrow focus" ~ " ", 
    Variety != "Andalusian" & Type == "Interrogative Wh-" ~ " ", 
    Variety != "Andalusian" & Type == "Interrogative y/n" ~ " ", 
    TRUE ~ Type
  )) %>% 
