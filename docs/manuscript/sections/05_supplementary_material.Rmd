...
Table \@ref(tab:table-learner-variety-familiarity-model-summary). 
...
Table \@ref(tab:table-learner-variety-familiarity-conditional-effects). 
...
*Monolingual response accuracy*.

Raw accuracy plot \@ref(fig:plot-learner-native-accuracy)

(ref:plot-learner-native-accuracy) Stuff they made me do.
...
Raw accuracy table  \@ref(tab:table-learner-native-accuracy)
...
Variety matched Raw accuracy plot \@ref(fig:plot-variety-matched-native-accuracy)

(ref:plot-variety-matched-native-accuracy) Stuff they made me do.
...
Variety matched raw accuracy table \@ref(tab:table-variety-matched-native-accuracy)
...
read_csv(here("tables", "variety_matched_native_accuracy.csv")) %>% 
  knitr::kable(format = "pandoc", align = c("l", "r", "r", "r", "r"), 
    caption = "Variety-matched response accuracy as a function of utterance type. Accuracy refers to the proportion of correct responses along with the standard error of the mean.",
...
*Speakers*. The auditory stimuli consisted of 8 varieties of Spanish: Cuban, Peninsular-Madrileño, Peninsular-Andalusian, Puerto Rican, Chilean, Argentine, Mexican, and Peruvian.
...
Spectrograms \@ref(fig:plot-spectrogram-andalusian)
...
knitr::include_graphics(
    here("figs", "stimuli", "spectrogram_andaluz.png")
  )
...
*Sentences*. Table \@ref(tab:table-stimuli-items)
