...
The summary of the response accuracy model is avaibale in Table \@ref(tab:table-learner-accuracy-by-utterance-type). 
...
Though some of the slower varieties coincide with those associated with higher response accuracy (compare with Figure \@ref(fig:plot-learner-accuracy-rt-by-speaker-variety)), the opposite is also true, e.g., Mexican Spanish. 
