...
As touched upon above, a speaker can use prosody to signal numerous additional pragmatic functions as well. Consider the following example:

A: Fui al club con Jon anoche.
B: Con Jon?
L+¡H* L% = echo question, speaker is clarifying who A went with because they didn't hear.
L+H* HH% = counterexpectational, speaker is surprised A went with Jon and not someone else.
L+H* LM% = statement of the obvious, speaker is unsurprised that A went with Jon.
