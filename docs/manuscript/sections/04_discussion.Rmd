...
We used Bayesian methods, in particular Drift Diffusion modelling [@ratcliff2008diffusion], to analyze data from `r n_learners` L2 learners. 
<!-- modeling? -->
...
The first question, *Is perceptional development in L2 Spanish modulated by proficiency and intonation type [i.e., @bustin_2020]?*, was developed as a direct result of the previous literature examining the acquisition of Spanish prosody [i.e., @trimble2013perceiving; @bustin_2020]. 
...
Though the construct *empathy* has been considered in the SLA literature, the current body of research is limited to studies on pronunciation accuracy [i.e., @guiora_1968; @guiora1972empathy; @rota2009cognitive, among others]. 
Thus, we extend research on empathy to L2 phonological acquisition of as it relates to speech perception. 
...
Aside from addressing response accuracy, we also show that in high proficiency, high empathy learners (1) more information was necessary to reach a decision and (2) responses came at a slower rate when compared with low empathy learners at any proficiency level. <!-- this sentence was a little hard to parse for me, we might consider changing the (1) to "firstly" and (2) to "secondly" or something similar -->
...
<!-- it seems like sometimes we use the term "intonation cues" and other times "intonational cues". The latter sounds better to me, if they are indeed interchangable -->
...
Given that empathy comprises the cognitive process of identifying the emotional state of another living being as well as the affective process of experiencing a similar sensation within onself, higher empathy individuals might show more sensitivity to intonation cues out of a general tendency to be more willing to devote their cognitive efforts to this area, which, consequently, may require more time than not devoting that effort. 
<!-- Two things: First, typo: oneself?, Second, the last part of this sentence is a litte ambiguous to me "may requires more time than not devoting that effort". Also, my reading of this point implies that the devotion of cognitive resources is an explicit process, which I am not sure I would necessarily agree with if we say that it is conscious/explicit. I suppose I am thinking of the finding (that higher empathy people took longer to process) as a sort of subconscious behavior. This is just an intuition, though. -->
...
As was the case with our pilot data from monolingual Spanish speakers, learners were most accurate responding to stimuli from the speaker of standard Peninsular Spanish, and least accurate when responding to the Cuban variety.
Interestingly, accuracy with a given variety did not correlate with response times in a straightforward way. 
For instance, participants did not respond faster to the standard Peninsular variety even though they were more accurate in their responses to this speaker. 
...
Mexican (`r familiarity$Mexico$perc`%) and Peninsular (`r familiarity$Spain$perc`%) Spanish were reported as being the second and third most familiar varieties, and no participants indicated Cuban Spanish as being the variety they were most familiar with. Thus, familiarity with the target variety may account for variety-specific response accuracy. 
...
Absolute interrogatives in Standard Peninsular Spanish, for example, have the common final rise found in many other varieties of Spanish, as well as Standard American English. 
...
Future research would benefit from considering the learnability of empathy [i.e., @lam2011empathy; @bertrand2018learning] as it relates to L2 outcomes. 
