...
**2AFC**. In the 2AFC, task participants were presented with an audio file containing a statement (broad focus or narrow focus) or a question (yes/no or wh-). 
...
Our hypothesis related to empathy as a possible mediator of perceptual learning is exploratory in nature; therefore, we did not base our sample size estimate on any parameter estimates related to this effect. 
