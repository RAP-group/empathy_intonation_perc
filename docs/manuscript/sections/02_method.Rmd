...
The pool of participants was filtered using criteria set in Prolific.ac to insure participants self-reported as being L1 English speakers born, raised, and currently living in the US with no knowledge of any languages other than English or Spanish.
...
The second analysis utilized Bayesian drift diffusion modeling [DDM, @ratcliff2008diffusion]. 
