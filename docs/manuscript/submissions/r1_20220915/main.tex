...
At the recommendation of all three reviewers we have included more information about the stimuli used in our study (please see the introduction and methods sections as well as the supplementary materials, as it is too much information to include here).
...
Following the suggestion of the reviewer we have included references to Erteschik-Shir (2007) and Casielles-Suárez (2004) for information structure and Pierrehumbert and Hirschberg (1990) for speaker belief states.
There relevant text now reads as follows:

\begin{quote}
The difficulties associated with intonation can result in comprehension and communication mishaps because the tune is associated not only with linguistic information, e.g., utterance type or syntactic constituency, but also pragmatic information, e.g., information structure (Casielles-Suárez, 2004; Erteschik-Shir, 2007), speaker belief states (Pierrehumbert \& Hirschberg, 1990), polite discourse (Astruc, Vanrell, \& Prieto, 2016), bias, or presupposition (Henriksen, Armstrong, \& García-Amaya, 2016).
...
These examples illustrate between-variety variability because they can differ from the more common final rise found in many other varieties of Spanish (see Hualde \& Prieto, 2015).
\end{quote}
...
To the point brought up here, indeed, there is a line a research that operationalizes empathy as a pragmatic skill (See Baron-Cohen, 2011; Baron-Cohen \& Wheelwright, 2004; Carruthers, 2009; Esteve-Gibert et al., 2020; Frith \& Frith, 2003, among others).
...
We also underscore the general need for models of L2 phonology, such as the SLM-r (Flege \& Bohn, 2021), PAM-L2 (Best \& Tyler, 2007), L2LP (Van Leussen \& Escudero, 2015), etc., to address the acquisition process beyond the level of the segment.
The LILt model (Mennen, 2015) has served as a starting point in the analysis of intonation across languages and L2 acquisition of intonation, framing the process of L2 acquisition of intonation along different developmental and structural dimensions.
...
We do, however, wish to point out that the sentence the reviewer quotes (p.~29, line 6) refers to the body of research on empathy in SLA, not monolinguals (i.e., Aziz-Zadeh, Sheng, \& Gheytanchi, 2010), nor the Autism Spectrum Quotient (i.e., Shang, 2022).
...
In theory this is true, though these same lexical items can also be present in statements (or parts of statements), e.g., ``Cuando empieza el partido\ldots{}'', ``Cuando empiece el partido\ldots{}'' vs.~``¿Cuándo empieza el partido?''.
...
Our elicitation of narrow focus is indeed slightly different from what is generally found in the extant literature and this is clear when comparing our narrow focus utterances with most of the documented tunes.
Most investigations elicit narrow focus using more specific pragmatic contexts (narrow focus correction, narrow focus contradiction), and not just narrow focus from answering an information seeking wh- question, which is what we did (following Brandl et al., 2020, which we replicate).
We believe that this difference, along with our stimuli being `lab speech' likely account for the contours we observed.
We have made sure to (a) explain how we elicited the utterances from our speakers in the revised manuscript, (b) provide additional detail in the supplementary materials, and (c) make clear that our stimuli contains between-variety and within-speaker variability.
Moving forward, we think it would be a good idea to elicit narrow focus using more contexts in order to see what effect this might have on the difficulty of the task.
...
We have also noticed the abundance of rising patterns in the wh- questions.
As you mention, in most, if not all Spanish varieties, interrogatives can have both final rises and final falls, with geolectal differences regarding how frequent they are and whether or not they are marked/unmarked pragmatically.
We believe these may be indications of `politeness' (Navarro Tomás 1944; Quilis 1993; Sosa 2003) or perhaps `interest' (Estebas-Vilaplana \& Prieto, 2010) or `formality' (Henriksen et al., 2010), likely due to our stimuli being `lab' speech.
...
As mentioned above, we believe the narrow focus we elicited might not coincide with the most documented contours because they tend to use more specific pragmatic contexts (narrow focus correction, narrow focus contradiction), and not just narrow focus from answering an information seeking wh- question.
...
Our Peruvian speaker (a male, and co-author of this paper) considers his productions to be an accurate portrayal of his variety, though we have not consulted with the speakers of the other varieties mentioned in the previous comment.
Be that as it may, a priori we expected learners to be less accurate and respond slower to the narrow focus condition (with regard to the broad focus condition) and this is precisely what we see in the data.
...
As we alluded to above, we believe that if the goal of this paper was to determine why/how certain contours were more or less difficult and how that relates to empathy, it would be necessary to have strict control over the contours associated with each utterance type.
In this case it would make perfect sense to include ``pattern used'' as a variable in our models.
Importantly, we do not intend to respond to that question at this time.
We believe that the patterns we have elicited illustrate the variability present both between varieties and within speakers, and, indeed, some patterns are likely more difficult than others.
As we know, the lack of invariance is inherent to all aspects of speech.
Importantly, our models include grouping variables for items and items nested within speakers, thus we account this type of variability via shrinkage of the parameter estimates.
This allows us to focus on our main goal (in this article) of analyzing the learners' ability to extract pragmatic meaning in a general sense (i.e., is this a question or not?).
\Done
\Easy
...
Once again, we thank the reviewer for the kind words and for taking the time to go above and beyond in their review of our materials.
Their comments have given us many ideas with regard to our next steps and future projects.
...
\leavevmode\vadjust pre{\hypertarget{ref-aziz2010common}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-craft2015acquisition}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-henriksen2010development}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-nibert2005acquisition}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-nibert2006acquisition}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-shang2022ns}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-thornberry2014l2}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-trimble2013acquiring}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-trimble2013perceiving}{}}%
