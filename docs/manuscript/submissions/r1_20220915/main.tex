...
This hypothesis is grounded in exploratory analyses of pilot data collected from 119 monolingual Spanish speakers in which responses to the Cuban variety were the least accurate (See Supplementary Materials for more information).
\end{quote}
...
The data from 119 monolingual Spanish speakers were used to pilot the items/task.
