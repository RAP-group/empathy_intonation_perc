...
This hypothesis is grounded in exploratory analyses of pilot data collected from 119 monolingual Spanish speakers (See Supplementary Materials for more information).
\end{quote}
...
The data from 119 monolingual Spanish speakers was used to pilot the items/task.
