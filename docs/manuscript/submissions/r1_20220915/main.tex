...
We believe that the patterns we have elicited are illustrate the variability present both between varieties and within speakers.
As we know, the lack of invariance is inherent to all aspects of speech.
At this stage in our project (in this article) we opted to focus on the learners' ability to extract pragmatic meaning in a general sense.
