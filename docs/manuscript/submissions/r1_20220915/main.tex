...
Astruc, L., Vanrell, M. del M., \& Prieto, P. (2016). Cost of the action and social distance affect the selection of question intonation in {C}atalan. In M. E. Armstrong, N. Henriksen, \& M. del M. Vanrell (Eds.), \emph{Intonational grammar in {I}bero-{R}omance: {A}pproaches across linguistic subfields} (pp. 93--113). John Benjamins Publishing Company. \url{https://doi.org/10.1075/ihll.6}
...
Henriksen, N., \& García-Amaya, L. J. (2012). Transcription of intonation of {J}erezano {A}ndalusian {S}panish. \emph{Estudios de {F}onética {E}xperimental}, 109--162.

\leavevmode\vadjust pre{\hypertarget{ref-henriksen2010development}{}}%
Henriksen, N., Geeslin, K. L., \& Willis, E. W. (2010). The development of {L}2 {S}panish intonation during a study abroad immersion program in {L}e{ó}n, {S}pain: {G}lobal contours and final boundary movements. \emph{Studies in Hispanic and Lusophone Linguistics}, \emph{3}(1), 113--162. https://doi.org/\url{https://doi.org/10.1515/shll-2010-1067}
