...
In theory this is true, though these same lexical items can also be present in statements (or parts of statements), e.g., "Cuando empieza el partido...", "Cuando empiece el partido..." vs. "¿Cuándo empieza el partido?". 
...
Most investigations elicit narrow focus using more specific pragmatic contexts (narrow focus correction, narrow focus contradiction), and not just narrow focus from answering an information seeking wh- question, which is what we did [following @bustin_2020, which we replicate]. 
...
We believe these may be indications of 'politeness' (Navarro Tomás 1944; Quilis 1993; Sosa 2003) or perhaps 'interest' [@estebas_prieto2010] or 'formality' [@henriksen2010development], likely due to our stimuli being 'lab' speech. 
