...
>
> The Autosegmental Metrical (AM) framework, developed by researchers like @pierrehumbert1980phonology and @ladd2008intonational, aims to map the instrumentally-derived F0 values onto sequential, discrete and categorically-distinct intonational events. 
...
For the present work we adopt the Spanish Tones and Breaks Indices (Sp\_ToBI) as described in @hualde2015intonational. 
...
learner_native_risefall_accuracy %>% 
  ...
  knitr::kable(format = "pandoc", align = c("l", "r", "r", "r"), 
    caption = "L2 and native listener response accuracy to yes/no questions as a function of variety, which have been labelled as *Cuban*, *Puerto Rican* (i.e., Caribbean) or *Other* (i.e., non-Caribbean). The stimuli from the Caribbean varieties were produced with falling intonational contours.",
