...
expName = 'empathy_intonation_perc_sp_pr'  # from the Builder filename that created this script
expInfo = {
    'participant': f"{randint(0, 999999):06.0f}",
    'study_id': 'pr',
    'session': '001',
    'Tu variedad del español*': 'Puerto Rico',
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/casillas/Desktop/empathy_intonation_perc_sp_pr/empathy_intonation_perc_sp_pr_lastrun.py',
...
for thisTrials_2afc_loop in trials_2afc_loop:
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    sound_stim_trial.setSound(puertorican, hamming=True)
