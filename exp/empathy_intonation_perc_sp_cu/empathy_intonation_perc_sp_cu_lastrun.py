...
expInfo = {
    ...
    'study_id': '',
    'session': '',
    'Tu variedad del español*': 'ej. cubano',
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/casillas/Desktop/empathy_intonation_perc_sp_cu/empathy_intonation_perc_sp_cu_lastrun.py',
...
for thisTrials_2afc_loop in trials_2afc_loop:
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    sound_stim_trial.setSound(cuban, hamming=True)
