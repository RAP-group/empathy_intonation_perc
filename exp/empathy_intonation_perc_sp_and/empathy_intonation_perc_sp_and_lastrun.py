...
expName = 'empathy_intonation_perc_sp_and'  # from the Builder filename that created this script
expInfo = {
    'participant': f"{randint(0, 999999):06.0f}",
    'study_id': 'and',
    'session': '001',
    'Tu variedad del español*': 'ej. gaditano',
    '¿Hablas con fluidez otra lengua (sí/no)?*': '',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/casillas/Desktop/empathy_intonation_perc_sp_and/empathy_intonation_perc_sp_and_lastrun.py',
...
instructions_2afc_loop = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('instructions/2afc_instructions_sp_text.csv'),
...
for thisTrials_2afc_loop in trials_2afc_loop:
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    sound_stim_trial.setSound(andalusian, hamming=True)
